    ...
    <div class="min-h-screen bg-gray-50 text-gray-900">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 md:mt-24 text-center">
            ...
            <p class="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
                Expedientes clínicos inteligentes, gestión multi-sucursal y control de roles diseñado específicamente
                para
                cumplir con la normativa médica en México (NOM-004 y NOM-024).
            </p>
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 pb-20 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                <div
                    class="w-14 h-14 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6 text-2xl">
                    🏥
                </div>
                <h3 class="text-xl font-bold mb-3">Gestión Multi-Sucursal</h3>
                <p class="text-gray-600">
                    ¿Trabajas en diferentes clínicas? Mantén tus precios, agendas y pacientes perfectamente aislados y
                    organizados según la sucursal activa.
                </p>
            </div>

            <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                <div
                    class="w-14 h-14 bg-cyan-100 text-cyan-600 rounded-xl flex items-center justify-center mb-6 text-2xl">
                    📁
                </div>
                <h3 class="text-xl font-bold mb-3">Expedientes Blindados</h3>
                <p class="text-gray-600">
                    Seguridad total. Soporte para pacientes titulares, dependientes y huérfanos de cuenta, manteniendo
                    la
                    trazabilidad legal en todo momento.
                </p>
            </div>

            <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
                <div
                    class="w-14 h-14 bg-indigo-100 text-indigo-600 rounded-xl flex items-center justify-center mb-6 text-2xl">
                    🔐
                </div>
                <h3 class="text-xl font-bold mb-3">Control de Accesos</h3>
                <p class="text-gray-600">
                    Delega sin perder el control. Permisos avanzados para médicos, administradores y secretariado,
                    protegiendo
