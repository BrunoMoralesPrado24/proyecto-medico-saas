<template>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a :href="route('patients.create')" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                + Nuevo Paciente
            </a>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr v-if="patients.length === 0">
                        <td colspan="3" class="px-6 py-4 text-center text-gray-500">No hay pacientes registrados en esta clínica.</td>
                    </tr>
                </tbody>
            </table>
        </div>
